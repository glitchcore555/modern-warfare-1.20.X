...
public class ModAnimationDefinitions {
    public static final AnimationDefinition BOMB_IDLE = AnimationDefinition.Builder.withLength(1.0F).looping()
    ...
    public static final AnimationDefinition BOMB_WALK = AnimationDefinition.Builder.withLength(0.375F).looping()
